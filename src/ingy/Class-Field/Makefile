# This Makefile is for the Class::Field extension to perl.
#
...
#     ABSTRACT => q[Class Field Accessor Generator]
#     AUTHOR => q[Ingy döt Net <ingy@cpan.org>]
#     DIR => []
#     DISTNAME => q[Class-Field]
#     NAME => q[Class::Field]
#     NO_META => q[1]
#     PL_FILES => {  }
#     PREREQ_PM => {  }
...
TO_INST_PM = lib/Class/Field.pm

PM_TO_BLIB = lib/Class/Field.pm \
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/Class/Field.pm $(INST_MAN3DIR)/Class::Field.$(MAN3EXT) 
...
ppd:
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>Class Field Accessor Generator</ABSTRACT>' >> $(DISTNAME).ppd
...
pm_to_blib : $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')' \
	  lib/Class/Field.pm blib/lib/Class/Field.pm 
