...
<a href="[% script_name %]?action=edit_see_locked&page_name=[% page_uri %]"
...
<a href="[% script_name %]?action=edit_see_share&page_name=[% page_uri %]" title="Edit This Page with SubEthaEdit">
